...
\textbf{Figure~\ref{fig:group-difficulty}} validates the efficacy of behavioral stratification: \textbf{\panelref{fig:group-difficulty}{a}} demonstrates that cluster assignments account for 72\% of predictability variance on held-out test subscribers, while \textbf{\panelref{fig:group-difficulty}{b}} confirms that cluster assignments computed from historical prefix segments correlate strongly with full-day assignments.
