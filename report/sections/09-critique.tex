...
The flatness of the scaling curve should be read in that light: what a
population has in common is a much smaller object than a personal habit, and it
is unsurprising that it is bought early.
