...
internship sits. Four colleagues worked on the same 15-day corpus with
different instruments; Nino ran his own descriptive analysis and used the tooling
he had built for it to extract the day-files I needed, Tiphain and Benjamin lent
two reusable ideas, and I contributed the fine-tuning branch. Everything below
the dashed line is what makes the branches comparable: a single, model-free
yardstick.}
