...
\figtext{%
\figpara{Anatomy and structure of cell identifier tokens in Figure~\ref{fig:cellid-anatomy}.}{On the left of Figure~\ref{fig:cellid-anatomy}, the antenna
name \cid{BSOCHO1} is taken apart: the first letter is the generation of radio, the
...
right of Figure~\ref{fig:cellid-anatomy}, one mast in the town of Cheb appears under four names. On the day used for
\textbf{Chapter~\ref{ch:groups}}, \textbf{12.4 out of every 100} back-to-back records are
