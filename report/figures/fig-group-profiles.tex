...
\figtext{%
\figpara{Figure~\ref{fig:group-profiles}: hourly transition frequencies across the four cohorts.}{The horizontal axis in Figure~\ref{fig:group-profiles} is the hour of the day. Each bar
...
\figpara{Figure~\ref{fig:group-profiles}: inverse mobility trends between G2 and G3.}{In Figure~\ref{fig:group-profiles}, G0 is flat and low, around 30 changes
