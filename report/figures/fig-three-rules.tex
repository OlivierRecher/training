...
\node[ttl] at (0,0)
  {\panelnum{fig:three-rules}{a} Never read the last pass\\ of a run};
...
\node[ttl] at (0,0)
  {\panelnum{fig:three-rules}{b} Where the day is cut\\ belongs to the ruler};
\draw[clrule] (0.25,-1.05) -- (0.25,-3.55) -- (4.45,-3.55);
...
\node[ttl] at (0,0)
  {\panelnum{fig:three-rules}{c} A test the one-line rule\\ already passes};
