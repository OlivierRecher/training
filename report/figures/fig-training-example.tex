...
\figtext{%
\figpara{Figures~\panelnum{fig:training-example}{a} and \panelnum{fig:training-example}{b}: JSON disk format and tokenized input sequence.}{Each
person's day is written in \panelref{fig:training-example}{a} as a record with three slots, two of them boilerplate and
the trajectory in the third, a layout chosen for compatibility with the TRL library. In \panelref{fig:training-example}{b}, the grey symbols set the scene and
