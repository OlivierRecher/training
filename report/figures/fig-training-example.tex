...
the trajectory in the third, a layout chosen only for compatibility with a library
that already knows how to read it. In panel (b) the grey symbols set the scene and
