...
one-line rule on that same set of people. In all four the score climbs for four to
...
\figpara{What it costs to read the wrong pass, and a warning about the dashed
line.}{In panel (a) the best pass scores 65.0\,\% and the last one 48.1\,\%, so
...
moves between panels, from 69.2\,\% on the unfiltered day to 43.5\,\% once only
mobile people are kept, because the people are different. The four panels are
