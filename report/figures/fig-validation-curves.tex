...
a run instead of its best point costs $16.9\pt$ of validation accuracy and
forty epochs of GPU time; measured on the held-out test users, the same choice
costs $15.5\pt$. Note that the dashed line moves between panels, 69.2\,\% on the
