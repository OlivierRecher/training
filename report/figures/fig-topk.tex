...
the same prediction fails at top-1 and succeeds at the other two: nothing about
the model changes, only how strict the question is. Reporting three depths is the
convention of this literature rather than a choice of mine
\cite{luca2021survey,qin2025mobllm}, because an operator that can prepare three
antennas in advance is served by a correct answer in third place.}
