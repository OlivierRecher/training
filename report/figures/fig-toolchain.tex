...
\label{fig:toolchain}
\figtext{%
\figpara{Read the stack from the bottom up.}{At the bottom is the machine, a
...
it reshapes files, splits people, and runs the statistical checks of
Chapter~\ref{ch:scale}.}

\figpara{Why the top layer had to be mine.}{Everything this report is about lives
there. Making a mistake at seven in the evening count more than one at two in the
