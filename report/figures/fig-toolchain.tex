...
\label{fig:toolchain}
\figtext{%
\figpara{Figure~\ref{fig:toolchain}: software toolchain architecture stack.}{At the bottom of Figure~\ref{fig:toolchain} is the machine, a
...
\figpara{Figure~\ref{fig:toolchain}: custom mobility evaluation framework layer.}{Everything this report is about lives
