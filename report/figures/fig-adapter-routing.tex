...
\figtext{%
\figpara{Figure~\ref{fig:adapter-routing}a: textual group token conditioning failure.}{Same people, same
protocol, same emphasised hours in both panels of Figure~\ref{fig:adapter-routing}; only the channel differs. In Figure~\ref{fig:adapter-routing}a, the kind of user was one extra symbol, \cid{<G0>} to \cid{<G3>}, at
...
\figpara{Figure~\ref{fig:adapter-routing}b: physical parameter routing via per-group LoRA adapters.}{In Figure~\ref{fig:adapter-routing}b, four separate sets of
