...
\figtext{%
\figpara{Panel (a): as a piece of text, and it was ignored.}{Same people, same
protocol, same emphasised hours in both panels; only the channel differs. In the
first attempt the kind of user was one extra symbol, \cid{<G0>} to \cid{<G3>}, at
...
\figpara{Panel (b): as a switch, and what it was worth.}{Four separate sets of
