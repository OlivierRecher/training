...
\figtext{%
\figpara{Reading the four bars.}{All four are on one scale, the share of moments
answered correctly. The two grey bars are published ceilings, the best score any
predictor could ever reach; the two blue ones are what the trivial rule and my
model actually score on my data. Song et al.\ put the ceiling at 93\,\%, which
sounds like an open invitation. Ikanovic and Mollgaard re-ran the same
measurement after deleting the moments where the person had not moved, and it
fell to 71\,\%: nearly a quarter of the famous 93 was the passage of time rather
than anybody's habits, which is the dashed part of the second bar.}

\figpara{The two bottom bars are different sets of people, deliberately.}{An
ordinary day file and a selection of people who genuinely move are not
comparable on absolute score, and the point of putting them together is exactly
that. The rule scores 69.2 on the first and 50.2 on the second without changing
a character of its own definition. Chapter~\ref{ch:data} makes that move and
explains it.}}
\end{figure}
