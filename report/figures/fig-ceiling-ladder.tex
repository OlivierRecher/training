...
model score on my data. Song et al.\ put the ceiling at 93\,\%. Ikanovic and
Mollgaard re-ran the same measurement after deleting the moments where the person
had not moved, and it fell to 71\,\%, the dashed part of the second bar.}
...
on absolute score. The rule scores 69.2 on the first and 50.2 on the second
without changing a character of its own definition; Chapter~\ref{ch:data} makes
