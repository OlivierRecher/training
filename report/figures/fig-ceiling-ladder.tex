...
\figtext{%
\figpara{Figure~\ref{fig:ceiling-ladder}: reading the four bars.}{All four bars in Figure~\ref{fig:ceiling-ladder} are on one scale, the share of moments
...
\figpara{Figure~\ref{fig:ceiling-ladder}: comparison of bottom bars across dataset cohorts.}{An
