...
\label{fig:protocol}
\figtext{%
\figpara{Figure~\ref{fig:protocol}a (prefix context split) and Figure~\ref{fig:protocol}b (sequential step evaluation).}{In Figure~\ref{fig:protocol}a, each
...
\emph{measurement} rather than a property of the model. In Figure~\ref{fig:protocol}b, the model is then not
