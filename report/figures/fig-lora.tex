...
\label{fig:lora}
\figtext{%
\figpara{Comparison of parameter adaptation methods in Figure~\ref{fig:lora}.}{The grey square in Figure~\ref{fig:lora} is the
...
together with about three more used to track how to adjust it. LoRA (b) \textbf{\cite{hu2022lora}} freezes the big table and trains two
narrow ones added beside it, so about 2 numbers in every 100 ever move. QLoRA (c)
