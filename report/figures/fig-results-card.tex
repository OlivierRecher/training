...
the \textbf{22.4} is the most robust of the three, because it appears in every
chapter that split its results by person.}

\figpara{What the dashed band is doing there.}{On a task whose honest yardstick is
one line of code, three corrections to how things were measured were each worth
more than any modelling idea I had. That is not a criticism of the modelling; it
is where I would tell somebody picking this up to look first.}}
