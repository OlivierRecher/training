...
\figtext{%
\figpara{Figure~\ref{fig:results-card}, cards 1--3: summary of key findings.}{Each card in Figure~\ref{fig:results-card} is the answer to one of the three
...
\figpara{Figure~\ref{fig:results-card}: methodological corrections highlighted.}{In Figure~\ref{fig:results-card}, on a task whose honest yardstick is
