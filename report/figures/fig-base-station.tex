...
\figtext{%
\figpara{Figures~\panelnum{fig:base-station}{a} and \panelnum{fig:base-station}{b}: what is drawn, and why it decides how movement is measured.}{Both panels
...
pointing in one direction. \panelref{fig:base-station}{a} has the four 2G cells alone; \panelnum{fig:base-station}{b} adds
