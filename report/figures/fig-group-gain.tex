...
whom repetition predicts less than one time in five, gains $+6.4\pt$. Across
the four groups the correlation between how easy a group is and how much the
model adds to it is $-0.99$. Read against Chapter~\ref{ch:user} this is the
