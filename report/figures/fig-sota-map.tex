...
\label{fig:sota-map}
\figtext{%
\figpara{How the four bands are ordered, and the honest debt.}{Top to bottom, from
...
boundary between the published task and the one I actually took on. The italic
line on each card says what that work gave me. None was found by looking for
support after the fact, except the third band: I sorted people into kinds of user
before reading Pappalardo and Jeong, and found afterwards that both the
observation and the mechanism were already published.}}
