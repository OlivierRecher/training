...
\figtext{%
\figpara{Three days on one clock, and the property that makes the task hard.}{One
line is one person's day from midnight to midnight, and one dot is one record
written by the network. Blue dots carry the same antenna name as the dot before
them, so nothing happened; orange dots carry a different one. The first two rows
