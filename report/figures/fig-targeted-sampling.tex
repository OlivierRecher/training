...
visible. Grey-blue is the one-line rule, dark blue my model, on exactly the same
...
on a segment chosen \emph{in advance}. But the fourth pair is everything outside
...
really are the hard ones, and Table~\ref{tab:group-windows} shows they were not.
