...
\begin{table}[t]
\centering\small
\caption{Users whose accuracy collapses when given more context}
...
\figtext{%
The eight users behind the aggregate of Table~\ref{tab:context-sweep}, scored
with a short context (30--60\,\% of the day) and then with a long one (80--90\,\%). More history is supposed to help. For the bottom four it destroys the
prediction, which is what pointed at the \emph{end} of the day, and therefore
at time of day, as the missing signal. \smob, same trained model evaluated at
several context fractions.}
