...
\figtext{%
\figpara{Data provenance mapping for experimental results in Table~\ref{tab:provenance}.}{Every number quoted anywhere in the body can be
...
\figpara{Reproducibility tracking across notebook runs in Table~\ref{tab:provenance}.}{Two rows in Table~\ref{tab:provenance} measured on
