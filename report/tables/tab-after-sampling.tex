...
\begin{table}[t]
\centering\small
\caption{The cost of targeted transition sampling}
...
\figtext{%
The same test users and the same protocol, before and after the three
targeted-sampling changes. The gap to the baseline widens at \emph{every}
context fraction, and top-3/top-5 fall by $2.6$ to $4.8\pt$ everywhere. A
single degraded row would be noise; seven consistent rows are a narrowed
model. \smob, 100 held-out users.}
