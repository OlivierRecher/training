...
\figtext{%
\figpara{Parameters and column descriptions of Table~\ref{tab:context-sweep}.}{Only where each person's day
...
\figpara{Persistence baseline variation across context fractions in Table~\ref{tab:context-sweep}.}{The \textbf{Rule} column in Table~\ref{tab:context-sweep} changes from row
