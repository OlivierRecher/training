...
\figpara{The three rows that matter most.}{\textbf{Max passes} with \textbf{Early
stopping} is the rule of Chapter~\ref{ch:tools}: twenty passes are allowed, the run
...
Chapters~\ref{ch:time} and~\ref{ch:groups} differ, and it is the only substantive
