...
\figtext{%
\figpara{Table~\ref{tab:hyperparams}: hyperparameter configurations across experimental iterations.}{One column per family of runs in Table~\ref{tab:hyperparams}, in chronological order.
...
\figpara{Table~\ref{tab:hyperparams}: key training hyperparameter settings.}{\textbf{Max passes} with \textbf{Early
